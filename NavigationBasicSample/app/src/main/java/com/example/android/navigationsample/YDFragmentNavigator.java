 ...
 */
@Navigator.Name("ydfragment")
public class YDFragmentNavigator extends Navigator<YDFragmentNavigator.Destination> {
    ...
    public YDFragmentNavigator(@NonNull Context context, @NonNull FragmentManager manager,
                               int containerId) {
        mContext = context;
    ...
    /**
     * NavDestination specific to {@link YDFragmentNavigator}
     */
    ...
    public static class Destination extends NavDestination {
        ...
        public Destination(@NonNull NavigatorProvider navigatorProvider) {
            this(navigatorProvider.getNavigator(YDFragmentNavigator.class));
        }
         ...
         * Fragment via {@link #setClassName(String)}.
         *
         * @param fragmentNavigator The {@link YDFragmentNavigator} which this destination
